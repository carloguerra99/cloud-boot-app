...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/carloguerra/PycharmProjects/cloud-boot-app/virgin_venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/carloguerra/PycharmProjects/cloud-boot-app/virgin_venv/bin/deactivate.nu'
